...
namespace TGC.GrupoMs.Model.Elementos
{
    /// <summary>
    ...
    /// </summary>
    public class GodCamera : TgcCamera
    {
        ...
        public GodCamera(TgcD3dInput input)
        {
            Input = input;
        ...
        public GodCamera(Vector3 positionEye, TgcD3dInput input) : this(input)
        {
            this.positionEye = positionEye;
        }

        public GodCamera(Vector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        public GodCamera(Vector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed,
            TgcD3dInput input)
